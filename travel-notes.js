...
(function () {
  ...
  /* ---- IDB 版本迁移框架（2026-08-15）：数据结构变化时新增迁移函数，勿改历史函数 ---- */
  var DB_VERSION = 1;
  var DB_MIGRATIONS = {
    1: function (db) {
      /* v1：初始建表（notes + 索引） */
...
<div class="tn-viewrow"><button class="tn-viewtab on" id="tnViewTrip">旅程</button><button class="tn-viewtab" id="tnViewTime">时间线</button><button class="tn-viewtab" id="tnViewCal">日历</button></div>\
