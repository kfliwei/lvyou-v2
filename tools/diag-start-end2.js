...
(async () => {
  ...
  console.log('before click: wlPlan=', await page.evaluate(() => !!document.getElementById('wlPlan')));
  console.log('before click: wlPlanBtn=', await page.evaluate(() => !!document.getElementById('wlPlanBtn')));
  ...
  const d = await page.evaluate(() => ({
    ...
    planDays: Array.isArray(window.__planDays) ? window.__planDays.length : 'none',
    wishCount: window.Wish ? window.Wish.list().length : -1
  }));
